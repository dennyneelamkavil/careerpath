    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center gap-12">
            <div className="flex-1 text-center lg:text-left">
              ...
              <p className="text-lg md:text-xl text-slate-600 dark:text-slate-400 mb-8 max-w-2xl mx-auto lg:mx-0">
                AI-powered career assessment helping you find the perfect career
                match based on your skills, personality, and interests.
              </p>
              <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-4">
                <Link
                  href="/assessment"
                  className="px-8 py-4 bg-primary text-white font-bold rounded-xl text-lg shadow-lg shadow-primary/20 hover:scale-[1.02] transition-transform text-center"
                >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-slate-600 dark:text-slate-400">
                Comprehensive tools to guide your professional journey.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-white dark:bg-slate-800 p-8 rounded-2xl border border-slate-200 dark:border-slate-700 hover:shadow-xl transition-shadow">
                ...
                <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
                  Science-backed tests to find your professional strengths and
                  natural abilities.
                </p>
              </div>
              <div className="bg-white dark:bg-slate-800 p-8 rounded-2xl border border-slate-200 dark:border-slate-700 hover:shadow-xl transition-shadow">
                ...
                <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
                  Deep dive into your traits, soft skills, and work-style
                  preferences.
                </p>
              </div>
              <div className="bg-white dark:bg-slate-800 p-8 rounded-2xl border border-slate-200 dark:border-slate-700 hover:shadow-xl transition-shadow">
                ...
                <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
                  Detailed insights and actionable roadmaps tailored
              ...
              <div className="bg-white dark:bg-slate-800 p-8 rounded-2xl border border-slate-200 dark:border-slate-700 hover:shadow-xl transition-shadow">
                ...
                <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
                  AI-driven matches for your unique profile based on market
                  trends.
                </p>
              </div>
            </div>
        ...
        <section className="py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold mb-16 text-center lg:text-left">
              How It Works
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
              ...
              <div className="relative flex flex-col items-center lg:items-start text-center lg:text-left">
                ...
                <p className="text-slate-600 dark:text-slate-400">
                  Complete our AI-driven questionnaire designed by
                  psychologists.
                </p>
              </div>
              <div className="relative flex flex-col items-center lg:items-start text-center lg:text-left">
                ...
                <p className="text-slate-600 dark:text-slate-400">
                  We evaluate your strengths, interests, and potential growth
                  areas.
                </p>
              </div>
              <div className="relative flex flex-col items-center lg:items-start text-center lg:text-left">
                ...
                <p className="text-slate-600 dark:text-slate-400">
                  Receive your personalized career path with learning steps.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4">
              <div>
                ...
                <p className="text-slate-600 dark:text-slate-400">
                  Find opportunities in the most in-demand industries.
                </p>
              </div>
              <a
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white dark:bg-slate-800 p-8 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm">
                ...
                <p className="text-slate-600 dark:text-slate-300 italic mb-8 leading-relaxed">
                  &quot;The AI assessment was scarily accurate. It helped me
                  switch from Business to UX Design, and I&apos;ve never been
                  happier!&quot;
                </p>
              ...
              <div className="bg-white dark:bg-slate-800 p-8 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm">
                ...
                <p className="text-slate-600 dark:text-slate-300 italic mb-8 leading-relaxed">
                  &quot;The personalized report gave me a clear roadmap for the
                  skills I needed to learn. It removed all the confusion about
                  my future.&quot;
                </p>
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-full overflow-hidden bg-slate-200 relative">
              ...
              <div className="bg-white dark:bg-slate-800 p-8 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm">
                ...
                <p className="text-slate-600 dark:text-slate-300 italic mb-8 leading-relaxed">
                  &quot;Highly recommend for anyone feeling stuck in their
                  current path. The insights into personality traits were
                  eye-opening.&quot;
                </p>
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-full overflow-hidden bg-slate-200 relative">
          ...
          <div className="max-w-5xl mx-auto rounded-3xl bg-primary px-8 py-16 text-center text-white relative overflow-hidden shadow-2xl">
            ...
            <div className="relative z-10">
              <h2 className="text-3xl md:text-5xl font-black mb-6">
                Start Discovering Your Ideal Career Today
              </h2>
              <p className="text-white/80 text-lg mb-10 max-w-xl mx-auto leading-relaxed">
                Join over 50,000 students who have found their professional
                purpose through CareerPath.
              </p>
              <Link
                href="/assessment"
                className="inline-block px-10 py-4 bg-white text-primary font-bold rounded-xl text-xl hover:bg-slate-100 transition-colors shadow-lg"
              >
                Start Assessment
              </Link>
            </div>
