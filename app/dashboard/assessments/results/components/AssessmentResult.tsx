...
export default function AssessmentResult({ id }: Props) {
  ...
  return (
    <div className="flex-1 overflow-y-auto p-6 lg:p-10 space-y-8 max-w-7xl mx-auto w-full font-sans">
      {/* Header Section */}
      <div>
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-4">
          <div className="max-w-2xl">
            ...
            <p className="text-slate-500 dark:text-slate-400 text-lg">
              Based on your responses, here are your personality strengths and
              career matches designed to align with your natural aptitudes.
            </p>
          </div>
            ...
            <div className="w-48 h-48 relative flex-shrink-0">
              ...
              >
                ...
                {radarOrder.map((item, idx) => {
                  ...
                  return (
                    <circle key={idx} cx={cx} cy={cy} r="4" fill="#4f46e5" />
                  );
                })}
              </svg>
      ...
      <div className="flex flex-col md:flex-row rounded-2xl overflow-hidden shadow-sm border border-slate-200 dark:border-slate-800">
        <div className="bg-[#0f172a] text-white p-8 md:p-12 md:w-1/3 flex flex-col justify-center">
          ...
          <p className="text-slate-400 font-medium text-lg">
            The {HOLLAND_MAP[hollandLetters[0]]?.name || "Versatile"} Architect
          </p>
        </div>
        <div className="bg-white dark:bg-slate-900 p-8 md:p-12 md:w-2/3 flex flex-col justify-center">
          <p className="text-slate-600 dark:text-slate-300 text-lg leading-relaxed italic mb-8">
            ...
            {HOLLAND_MAP[hollandLetters[0]]?.name} score suggests a deep-seated
            need for your primary motivators, while your{" "}
            {HOLLAND_MAP[hollandLetters[1]]?.name} affinity drives you to find
            elegant, human-centric solutions. You aren&apos;t just a
